 ...
 */
function aqh_preprocess_html (&$vars) {
  ...
  // Add Local styles
  // drupal_add_css('http://localhost/dev/aqh/css/style.css', array('group' => CSS_THEME, 'type' => 'external'));
}

/**
 * Fix for SEO
 */
function aqh_html_head_alter(&$head_elements) {
 ...
 */
function aqh_menu_tree__main_menu(&$vars) {
 ...
 */
function aqh_menu_link__main_menu(&$vars) {
